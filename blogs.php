...
if (isset($_GET['q'])) {
  $search_query = $_GET['q'];
  $blogs = search_blogs2($search_query);
  ...
  if ($field == "Other") {
    $blogs = get_all_top_blogs(20);
  } else {
    $blogs = get_blogs($field);
  }
}
...
<body>
  ...
  <div class="d-flex justify-content-end mx-3 p-2">
    <a href="./all_blogs.php" class="btn btn-primary">Other Blogs</a>
  </div>
